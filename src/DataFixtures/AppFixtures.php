...
class AppFixtures extends Fixture
{
    ...
    public function load(ObjectManager $manager): void
    {
        ...
        $user1->setPassword(
            $this->userPasswordHasher->hashPassword($user1, 'test')
        );
        ...
        $user2->setPassword(
            $this->userPasswordHasher->hashPassword($user1, 'test2')
        );
        ...
        $microPost3->setTitle('Welcome to Czech');
        $microPost3->setText('Welcome to Czech');
